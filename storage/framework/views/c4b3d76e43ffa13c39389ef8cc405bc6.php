        ...
        <div class="card h-100 border border-secondary-subtle rounded-4 p-4 bg-white transition shadow-sm hover-shadow">
            <div class="d-flex align-items-center justify-content-between mb-4">
                ...
                <span class="badge bg-success-subtle text-success border border-success-subtle px-3 py-1 rounded-pill" style="font-size: 12px;">
                    <?php echo e($category->competitions->count()); ?> Kompetisi
                </span>
            </div>
            
            <h4 class="fw-bold mb-2 text-dark" style="font-size: 18px;"><?php echo e($category->name); ?></h4>
            <p class="text-muted small lh-relaxed mb-4">
                Temukan berbagai kompetisi menarik di bidang <?php echo e($category->name); ?>.
            </p>
            <a href="<?php echo e(route('kategori.detail', ['id' => $category->id, 'slug' => Str::slug($category->name)])); ?>" class="mt-auto text-decoration-none fw-semibold small d-flex align-items-center gap-1 text-primary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Yudi\Documents\UAS Web\portal-lomba-ti\resources\views/kategori.blade.php ENDPATH**/ ?>