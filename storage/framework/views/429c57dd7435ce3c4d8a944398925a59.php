...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin - Portal Lomba TI'); ?></title>
...
<body>
    ...
    <aside class="admin-sidebar">
        <div class="px-2 mb-4">
            <a href="<?php echo e(url('/')); ?>" class="sidebar-brand text-primary">Portal Lomba TI</a>
        ...
        <nav class="nav nav-custom flex-column flex-grow-1">
            ...
            <a class="nav-link <?php echo e(Request::is('admin/lomba*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.lomba')); ?>">
                <span class="material-symbols-outlined">event_note</span>
                <span>Kelola Lomba</span>
            </a>
            <a class="nav-link <?php echo e(Request::is('admin/kategori*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.kategori')); ?>">
                <span class="material-symbols-outlined">category</span>
                <span>Kategori</span>
            </a>
            <a class="nav-link <?php echo e(Request::is('admin/pengguna*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.pengguna')); ?>">
        ...
        <div class="mt-auto nav-custom">
            <div class="px-3 py-2 mb-3 bg-white/50 rounded-3 border border-dark-subtle/10 text-center">
                ...
                <span class="fw-bold text-dark small"><?php echo e(Auth::user()->name ?? 'Yudi Admin'); ?></span>
            </div>
            <a class="nav-link <?php echo e(Request::routeIs('admin.pengaturan') ? 'active' : ''); ?>" href="<?php echo e(route('admin.pengaturan')); ?>">
    ...
    <main class="admin-main">
        <header class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="fw-bold mb-1" style="font-size: 28px; letter-spacing: -0.02em;"><?php echo $__env->yieldContent('header_title', 'Dashboard Overview'); ?></h2>
                <p class="text-muted mb-0" style="font-size: 15px;"><?php echo $__env->yieldContent('header_subtitle', 'Selamat datang kembali, Super Admin.'); ?></p>
            </div>
            
            <div class="d-flex align-items-center gap-3">
                <form action="<?php echo e(route('admin.lomba')); ?>" method="GET" class="search-container d-none d-md-block">
                    ...
                    <input type="text" name="search" class="search-input" value="<?php echo e(request('search')); ?>" placeholder="Cari nama kompetisi...">
                </form>
                ...
                <div class="dropdown">
                    <a class="d-flex align-items-center gap-2 profile-pill dropdown-toggle hide-caret text-decoration-none" 
                       ...
                       aria-expanded="false">
                        <div class="rounded-circle bg-primary text-white d-flex align-items-center justify-content-center fw-bold" style="width: 32px; height: 32px; font-size: 14px;">
                            <?php echo e(strtoupper(substr(Auth::user()->name ?? 'Y', 0, 1))); ?>

                        </div>
                        <span class="text-dark fw-semibold px-1" style="font-size: 14px;">
                            <?php echo e(Auth::user()->name ?? 'Yudi Admin'); ?>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2 p-2 rounded-3" aria-labelledby="adminProfileDropdown" style="min-width: 210px;">
                        <li class="px-3 py-2">
                            <p class="fw-bold mb-0 text-dark small"><?php echo e(Auth::user()->name ?? 'Yudi Admin'); ?></p>
                            <small class="text-muted" style="font-size: 11px;"><?php echo e(Auth::user()->email ?? 'admin@portal.com'); ?></small>
                            <span class="badge bg-primary-subtle text-primary d-block mt-1 text-center" style="font-size: 10px; width: fit-content;"><?php echo e(ucfirst(Auth::user()->role ?? 'admin')); ?></span>
                        </li>
...
</html><?php /**PATH C:\Users\Yudi\Documents\UAS Web\portal-lomba-ti\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>