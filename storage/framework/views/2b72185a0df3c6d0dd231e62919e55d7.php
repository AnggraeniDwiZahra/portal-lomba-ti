<?php $__env->startSection('title', $lomba->title . ' - Detail Lomba TI'); ?>
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-3">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('lomba.index')); ?>" class="text-white-50 text-decoration-none">Lomba</a></li>
            ...
            <div class="row align-items-center g-4">
                <div class="col-lg-8">
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        ...
                        <span class="badge bg-primary px-3 py-2" style="border-radius: 30px;"><?php echo e($lomba->level->name ?? 'Nasional'); ?></span>
                        
                        <span class="badge bg-light text-dark px-3 py-2" style="border-radius: 30px;"><?php echo e($lomba->category->name ?? 'Kategori'); ?></span>
                    </div>
                    <h1 class="fw-bold display-6 mb-3"><?php echo e($lomba->title); ?></h1>
                    <p class="lead text-white-50 fs-6 mb-0">Diposting oleh <span class="text-white fw-semibold"><?php echo e($lomba->user->name ?? 'Admin'); ?></span></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="img-detail-container mb-4 shadow-sm">
                    ...
                    <img src="<?php echo e($lomba->poster ? asset('storage/' . $lomba->poster) : 'https://images.unsplash.com/photo-1542831371-29b0f74f9713?auto=format&fit=crop&w=1200&q=80'); ?>" alt="<?php echo e($lomba->title); ?> Poster">
                </div>

                <div class="card border-0 shadow-sm p-4 mb-4" style="border-radius: 16px;">
                    <h4 class="fw-bold mb-3">Deskripsi Kompetisi</h4>
                    <p class="text-muted lh-lg mb-0" style="white-space: pre-line;"><?php echo e($lomba->description); ?></p>
                </div>
                    ...
                    <div class="card border-0 shadow-sm p-4 mb-4" style="border-radius: 16px;">
                        <div class="info-row">
                            ...
                            <div>
                                ...
                                <span class="fw-bold text-danger">
                                    <?php echo e(\Carbon\Carbon::parse($lomba->deadline)->format('d F Y')); ?>
                        ...
                        <div class="info-row">
                            ...
                            <div>
                                ...
                                <span class="fw-bold text-dark"><?php echo e($lomba->category->name ?? '-'); ?></span>
                            </div>
                        </div>
                        <div class="info-row">
                            ...
                            <div>
                                ...
                                <span class="fw-bold text-dark"><?php echo e($lomba->level->name ?? '-'); ?></span>
                            </div>
                        </div>

                        <div class="mt-4 gap-2 d-flex flex-column">
                            
                            <a href="<?php echo e($lomba->registration_link); ?>" target="_blank" class="btn btn-primary text-white text-center py-3 fw-bold text-decoration-none" style="border-radius: 12px; background-color: #0051d5; border: none;">
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <form action="<?php echo e(route('peserta.lomba.toggle', $lomba->id)); ?>" method="POST" class="m-0">
                                    <?php echo csrf_field(); ?>
                                    <?php if(Auth::user()->savedCompetitions->contains($lomba->id)): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Yudi\Documents\UAS Web\portal-lomba-ti\resources\views/detail-lomba.blade.php ENDPATH**/ ?>