        ...
        <div class="register-card p-4 p-md-5">
            ...
            <form action="<?php echo e(route('register.process')); ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="name" class="form-control" id="name" value="<?php echo e(old('name')); ?>" placeholder="Nama lengkap Anda" required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" name="email" class="form-control" id="email" value="<?php echo e(old('email')); ?>" placeholder="nama@email.com" required>
                    </div>
                </div>
            ...
            <footer class="mt-4 text-center">
                <p class="text-muted small m-0">
                    Sudah memiliki akun? <a class="fw-bold text-decoration-none" href="<?php echo e(route('login')); ?>" style="color: #0051d5;">Masuk di Sini</a>
                </p>
            </footer>
        </div>
    </main>
...
</html><?php /**PATH C:\Users\Yudi\Documents\UAS Web\portal-lomba-ti\resources\views/auth/register.blade.php ENDPATH**/ ?>