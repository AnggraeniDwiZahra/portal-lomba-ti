        ...
        <div class="row g-4 position-relative align-items-center">
            ...
            <div class="col-md-6 ps-5 ps-md-5">
                <div class="card border border-secondary-subtle rounded-4 p-4 bg-white shadow-sm hover-line-left">
                    ...
                    <a href="<?php echo e(route('lomba.index')); ?>" class="btn btn-primary btn-sm px-4 rounded-3 text-white d-inline-flex align-items-center gap-1 w-auto align-self-start" style="background-color: #0051d5; border: none; font-size: 13px;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Yudi\Documents\UAS Web\portal-lomba-ti\resources\views/panduan.blade.php ENDPATH**/ ?>